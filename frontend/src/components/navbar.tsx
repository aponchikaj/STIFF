...
export function Navbar() {
  return (
    <header className="site-header sticky top-0 z-50 border-b border-foreground bg-background/90 backdrop-blur">
      <nav
        aria-label="Main"
      ...
      >
        ...
        >
          ...
          <span className="hidden font-display text-base uppercase leading-none tracking-tight sm:inline sm:text-xl">
            Stiff
          </span>
        </Link>
