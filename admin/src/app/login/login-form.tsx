  ...
  return (
    <div className="w-full max-w-[380px]">
      ...
      <div className="rounded-[var(--radius-card)] border border-line bg-card p-7 shadow-[var(--shadow-raised)]">
        <h1 className="font-display text-[26px] leading-none">Shop admin</h1>
        <p className="mt-2.5 text-[12px] leading-5 text-muted">Products, orders, the gallery and what the site says.</p>
      ...
      <p className={`${labelCls} mt-5 text-center normal-case tracking-normal`}>
        Admins are promoted, never registered. Nobody signs up here.
      </p>
    </div>
  );
}
