...
export class InitialSchema1786441623740 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "page_views" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "path" character varying(200) NOT NULL, "visitorId" uuid NOT NULL, "userId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3b1047277a9c2a8cfd618787671" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_731b31872f76dd00f9d5b34761" ON "page_views"  ("path") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1e55c7b3225bb9f2520e883449" ON "page_views"  ("visitorId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_72e1c729a5408f7da7c744689b" ON "page_views"  ("createdAt") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "email_tokens_type_enum" AS ENUM('verify', 'reset')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_aa5917bcee5cc8579c2f390892" ON "email_tokens"  ("userId", "type") `,
    );
    await queryRunner.query(
      `CREATE TABLE "refresh_tokens" ("id" uuid NOT NULL, "userId" uuid NOT NULL, "tokenHash" character varying NOT NULL, "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL, "revokedAt" TIMESTAMP WITH TIME ZONE, "replacedById" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7d8bee0204106019488c4c50ffa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "comments_targettype_enum" AS ENUM('product', 'gallery')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "reactions_targettype_enum" AS ENUM('product', 'gallery')`,
    );
    await queryRunner.query(
      `CREATE TYPE "reactions_type_enum" AS ENUM('like', 'dislike')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_78566f399e21723dcdd6754226" ON "reactions"  ("targetType", "targetId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "email_tokens" ADD CONSTRAINT "FK_0a5e6c81093655b770eabd04600" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "email_tokens" DROP CONSTRAINT "FK_0a5e6c81093655b770eabd04600"`,
    );
